...
//CLASS methods
	...
	{   
        ...
        public function setPanelHead_1(){//set the panel 1 heading 
            if ($this->pageID == 'changePass')
                $this->panelHead_1='<h3>Change Your Password!</h3>';
        ...
        public function setPanelContent_1(){//set the panel 1 content
            if ($this->pageID == 'changePass')
            {
                $this->panelContent_1 = file_get_contents('forms/form_changepass.html');  //this reads an external form file into the string 
            }
        ...
        {
            $users=new MemberTable($this->db);
            if($users->changePassword($this->postArray,$this->user)){
