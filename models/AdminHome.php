	...
	function __construct($user,$pageTitle,$pageHead){   
        ...
        public function setPanelContent_2(){//set the panel 2 content
            ...
            if($this->loggedin){
                ...
                if ($this->user->getUserType()==='ADMIN'){ //An ADMIN is logged in
                    $this->panelContent_2='Thank you <b>'.$this->user->getUserFirstName().' '.$this->user->getUserLastName() .'</b> for logging in successfully as a ADMIN to the sample Web Application Framework. Please use the links above to manage your modules, students and grades. <br><br>Don\'t forget to logout when you are done.';
                }  
            }
            else{  //User is not logged in        
