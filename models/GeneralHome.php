...
//CLASS methods
	...
	function __construct($user,$pageTitle,$pageHead){   
        ...
        public function setPanelHead_1(){//set the panel 1 heading
                $this->panelHead_1='<h3>Term Project</h3>';
        }//end METHOD - //set the panel 1 heading
        public function setPanelContent_1(){//set the panel 1 content
            //User is not logged in
                 $this->panelContent_1.='<p>Welcome to the Animal Crossing Item Catalogue! Project produced by student K00252664, as part of the continuous assessment
                     for the module Data Design and Programming, Software Development Year 2. </p>
                     <hr><p>Please log in or register to view the catalogues!</p>';  
        ...
        public function setPanelContent_2(){//set the panel 2 content
            ...
            $this->panelContent_2='You are required to login - Please use the link above to login. This login page supports login for 3 user types: ADMIN, MANAGER and CUSTOMER';          
