<?php
/**
 * Class: Class: Content Model for generation of view content for Customer Home
 *
...
//CLASS methods
	...
	function __construct($user,$pageTitle,$pageHead){   
            parent::__construct('MemberHome',$user);
        ...
        public function setPanelHead_1(){//set the panel 1 heading
                $this->panelHead_1='<h3>HOME</h3>';
        }//end METHOD - //set the panel 1 heading
        public function setPanelContent_1(){//set the panel 1 content
            if($this->loggedin){ 
                if ($this->user->getUserType()==='MEMBER'){ //A MEMBER is logged in 
                    $this->panelContent_1.='<p>You are currently logged in as MEMBER.';
                }
            }
        ...
        public function setPanelContent_2(){//set the panel 2 content
            ...
            if($this->loggedin){
                ...
                if ($this->user->getUserType()==='MEMBER'){ //An ADMIN is logged in
                    $this->panelContent_2='Thank you <b>'.$this->user->getUserFirstName().' '.$this->user->getUserLastName() .'</b> for logging in successfully as a MEMBER to this application which is developed as a catalogue tool for the game Animal Crossing: New Horizons. Please use the links above to manage your catalogue of items! <br><br>Don\'t forget to logout when you are done.';
                }  
            }
            else{  //User is not logged in        
