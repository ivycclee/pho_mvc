	...
	{   
        ...
        public function setPanelContent_2(){//set the panel 2 content  
            ...
            if(isset($this->postArray['btnLogin'])){  //check that the login button is pressed
                ...
                $this->loggedin=$this->user->login($this->postArray['username'], $this->postArray['password']);                       
        ...
        public function setPanelContent_3(){ //set the panel 2 content
            if($this->loggedin){
                $this->panelContent_3='Panel 3 content - under construction (user logged in)';
            }
            else{        
                $this->panelContent_3='Panel 3 content - under construction (user not logged in)';
            }
        }  //end METHOD - //set the panel 2 content        
